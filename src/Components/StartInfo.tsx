...
const StartInfo = () => {
  ...
  return (
    <article className={classes.welcomeText}>
      ...
      <p className={classes.red}>Merci de ne pas nous envoyer de colis. Même si l'intention est très gentille, nous allons repayer les frais de douane, ce qui pourrait coûter très cher au final.</p>
    </article>
  );
}
