...
const GiftForm = ({ message, onSubmit, gift }: GiftFormType) => {
  ...
  const fileToDataUri = (file: File | undefined) =>
  ...
  const onFormSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    fileToDataUri(formData.image).then(data =>
      onSubmit({
        ...formData,
        image: data,
      })
    ...
    <>
      ...
      <form onSubmit={onFormSubmit} className={classes.form}>
        ...
        <FormControlLabel
          ...
          name="alreadyBought"
          control={<Switch onChange={onSwitchInputChange} checked={formData.alreadyBought} />}
